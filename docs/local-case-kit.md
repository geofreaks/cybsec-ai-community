...
The Local Case Kit is a protected runtime package for running CybSec-AI locally when hosted upload limits or evidence sensitivity make browser upload impractical.
